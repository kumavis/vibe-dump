...
// camp.
//
// Packed, the whole thing is 1940 x 1410 x 1010 above the deck: 1670 mm overall,
// 110 mm under the cab roof. It looks like a work truck with a canopy, which is
// the point.
// ---------------------------------------------------------------------------
...
function build(ctx) {
  ...
  return {
    massBudget: [
      ['subframe', 38],
      ['hard shell: 3 walls + floor', 62],
      ['pop-top lid + bellows + guides', 44],
      ['gullwing wall + props', 37],
      ['porch deck + spacers', 22],
      ['bunk deck + cabover slide', 60],
      ['stabiliser jacks (4)', 18],
      ['galley, water, bedding', 55],
    ],
    notes: [
