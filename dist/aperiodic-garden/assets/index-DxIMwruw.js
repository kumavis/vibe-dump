...
void main() {
	...
	`}function Rm(i){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){const c=a.mapping,l=c===To||c===wo,h=c===Xi||c===qi;if(l||h)if(a.isRenderTargetTexture&&a.needsPMREMUpdate===!0){a.needsPMREMUpdate=!1;let u=t.get(a);return e===null&&(e=new Rc(i)),u=l?e.fromEquirectangular(a,u):e.fromCubemap(a,u),t.set(a,u),u.texture}else{if(t.has(a))return t.get(a).texture;{const u=a.image;if(l&&u&&u.height>0||h&&u&&s(u)){e===null&&(e=new Rc(i));const f=l?e.fromEquirectangular(a):e.fromCubemap(a);return t.set(a,f),a.addEventListener("dispose",r),f.texture}else return null}}}return a}function s(a){let c=0;const l=6;for(let h=0;h<l;h++)a[h]!==void 0&&c++;return c===l}function r(a){const c=a.target;c.removeEventListener("dispose",r);const l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function Cm(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return t[n]=s,s}return{has:function(n){return e(n)!==null},init:function(n){n.isWebGL2?(e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance")):(e("WEBGL_depth_texture"),e("OES_texture_float"),e("OES_texture_half_float"),e("OES_texture_half_float_linear"),e("OES_standard_derivatives"),e("OES_element_index_uint"),e("OES_vertex_array_object"),e("ANGLE_instanced_arrays")),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture")},get:function(n){const s=e(n);return s===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function Pm(i,t,e,n){const s={},r=new WeakMap;function o(u){const f=u.target;f.index!==null&&t.remove(f.index);for(const g in f.attributes)t.remove(f.attributes[g]);for(const g in f.morphAttributes){const _=f.morphAttributes[g];for(let m=0,p=_.length;m<p;m++)t.remove(_[m])}f.removeEventListener("dispose",o),delete s[f.id];const d=r.get(f);d&&(t.remove(d),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function a(u,f){return s[f.id]===!0||(f.addEventListener("dispose",o),s[f.id]=!0,e.memory.geometries++),f}function c(u){const f=u.attributes;for(const g in f)t.update(f[g],i.ARRAY_BUFFER);const d=u.morphAttributes;for(const g in d){const _=d[g];for(let m=0,p=_.length;m<p;m++)t.update(_[m],i.ARRAY_BUFFER)}}function l(u){const f=[],d=u.index,g=u.attributes.position;let _=0;if(d!==null){const M=d.array;_=d.version;for(let x=0,v=M.length;x<v;x+=3){const R=M[x+0],T=M[x+1],A=M[x+2];f.push(R,T,T,A,A,R)}}else if(g!==void 0){const M=g.array;_=g.version;for(let x=0,v=M.length/3-1;x<v;x+=3){const R=x+0,T=x+1,A=x+2;f.push(R,T,T,A,A,R)}}else return;const m=new(Dl(f)?zl:Ol)(f,1);m.version=_;const p=r.get(u);p&&t.remove(p),r.set(u,m)}function h(u){const f=r.get(u);if(f){const d=u.index;d!==null&&f.version<d.version&&l(u)}else l(u);return r.get(u)}return{get:a,update:c,getWireframeAttribute:h}}function Lm(i,t,e,n){const s=n.isWebGL2;let r;function o(d){r=d}let a,c;function l(d){a=d.type,c=d.bytesPerElement}function h(d,g){i.drawElements(r,g,a,d*c),e.update(g,r,1)}function u(d,g,_){if(_===0)return;let m,p;if(s)m=i,p="drawElementsInstanced";else if(m=t.get("ANGLE_instanced_arrays"),p="drawElementsInstancedANGLE",m===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}m[p](r,g,a,d*c,_),e.update(g,r,_)}function f(d,g,_){if(_===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<_;p++)this.render(d[p]/c,g[p]);else{m.multiDrawElementsWEBGL(r,g,0,a,d,0,_);let p=0;for(let M=0;M<_;M++)p+=g[M];e.update(p,r,1)}}this.setMode=o,this.setIndex=l,this.render=h,this.renderInstances=u,this.renderMultiDraw=f}function Dm(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(e.calls++,o){case i.TRIANGLES:e.triangles+=a*(r/3);break;case i.LINES:e.lines+=a*(r/2);break;case i.LINE_STRIP:e.lines+=a*(r-1);break;case i.LINE_LOOP:e.lines+=a*r;break;case i.POINTS:e.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:n}}function Um(i,t){return i[0]-t[0]}function Im(i,t){return Math.abs(t[1])-Math.abs(i[1])}function Nm(i,t,e){const n={},s=new Float32Array(8),r=new WeakMap,o=new be,a=[];for(let l=0;l<8;l++)a[l]=[l,0];function c(l,h,u){const f=l.morphTargetInfluences;if(t.isWebGL2===!0){const g=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,_=g!==void 0?g.length:0;let m=r.get(h);if(m===void 0||m.count!==_){let U=function(){W.dispose(),r.delete(h),h.removeEventListener("dispose",U)};var d=U;m!==void 0&&m.texture.dispose();const x=h.morphAttributes.position!==void 0,v=h.morphAttributes.normal!==void 0,R=h.morphAttributes.color!==void 0,T=h.morphAttributes.position||[],A=h.morphAttributes.normal||[],I=h.morphAttributes.color||[];let S=0;x===!0&&(S=1),v===!0&&(S=2),R===!0&&(S=3);let b=h.attributes.position.count*S,O=1;b>t.maxTextureSize&&(O=Math.ceil(b/t.maxTextureSize),b=t.maxTextureSize);const G=new Float32Array(b*O*4*_),W=new Nl(G,b,O,_);W.type=Xn,W.needsUpdate=!0;const C=S*4;for(let H=0;H<_;H++){const Y=T[H],X=A[H],q=I[H],j=b*O*4*H;for(let tt=0;tt<Y.count;tt++){const nt=tt*C;x===!0&&(o.fromBufferAttribute(Y,tt),G[j+nt+0]=o.x,G[j+nt+1]=o.y,G[j+nt+2]=o.z,G[j+nt+3]=0),v===!0&&(o.fromBufferAttribute(X,tt),G[j+nt+4]=o.x,G[j+nt+5]=o.y,G[j+nt+6]=o.z,G[j+nt+7]=0),R===!0&&(o.fromBufferAttribute(q,tt),G[j+nt+8]=o.x,G[j+nt+9]=o.y,G[j+nt+10]=o.z,G[j+nt+11]=q.itemSize===4?o.w:1)}}m={count:_,texture:W,size:new Vt(b,O)},r.set(h,m),h.addEventListener("dispose",U)}let p=0;for(let x=0;x<f.length;x++)p+=f[x];const M=h.morphTargetsRelative?1:1-p;u.getUniforms().setValue(i,"morphTargetBaseInfluence",M),u.getUniforms().setValue(i,"morphTargetInfluences",f),u.getUniforms().setValue(i,"morphTargetsTexture",m.texture,e),u.getUniforms().setValue(i,"morphTargetsTextureSize",m.size)}else{const g=f===void 0?0:f.length;let _=n[h.id];if(_===void 0||_.length!==g){_=[];for(let v=0;v<g;v++)_[v]=[v,0];n[h.id]=_}for(let v=0;v<g;v++){const R=_[v];R[0]=v,R[1]=f[v]}_.sort(Im);for(let v=0;v<8;v++)v<g&&_[v][1]?(a[v][0]=_[v][0],a[v][1]=_[v][1]):(a[v][0]=Number.MAX_SAFE_INTEGER,a[v][1]=0);a.sort(Um);const m=h.morphAttributes.position,p=h.morphAttributes.normal;let M=0;for(let v=0;v<8;v++){const R=a[v],T=R[0],A=R[1];T!==Number.MAX_SAFE_INTEGER&&A?(m&&h.getAttribute("morphTarget"+v)!==m[T]&&h.setAttribute("morphTarget"+v,m[T]),p&&h.getAttribute("morphNormal"+v)!==p[T]&&h.setAttribute("morphNormal"+v,p[T]),s[v]=A,M+=A):(m&&h.hasAttribute("morphTarget"+v)===!0&&h.deleteAttribute("morphTarget"+v),p&&h.hasAttribute("morphNormal"+v)===!0&&h.deleteAttribute("morphNormal"+v),s[v]=0)}const x=h.morphTargetsRelative?1:1-M;u.getUniforms().setValue(i,"morphTargetBaseInfluence",x),u.getUniforms().setValue(i,"morphTargetInfluences",s)}}return{update:c}}function Fm(i,t,e,n){let s=new WeakMap;function r(c){const l=n.render.frame,h=c.geometry,u=t.get(c,h);if(s.get(u)!==l&&(t.update(u),s.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),s.get(c)!==l&&(e.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){const f=c.skeleton;s.get(f)!==l&&(f.update(),s.set(f,l))}return u}function o(){s=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:r,dispose:o}}class Xl extends He{constructor(t,e,n,s,r,o,a,c,l,h){if(h=h!==void 0?h:fi,h!==fi&&h!==Yi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===fi&&(n=Wn),n===void 0&&h===Yi&&(n=ui),super(null,s,r,o,a,c,h,n,l),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=a!==void 0?a:Ie,this.minFilter=c!==void 0?c:Ie,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const ql=new He,Yl=new Xl(1,1);Yl.compareFunction=Pl;const jl=new Nl,$l=new Sf,Kl=new Hl,Dc=[],Uc=[],Ic=new Float32Array(16),Nc=new Float32Array(9),Fc=new Float32Array(4);function es(i,t,e){const n=i[0];if(n<=0||n>0)return i;const s=t*e;let r=Dc[s];if(r===void 0&&(r=new Float32Array(s),Dc[s]=r),t!==0){n.toArray(r,0);for(let o=1,a=0;o!==t;++o)a+=e,i[o].toArray(r,a)}return r}function xe(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function ve(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function wr(i,t){let e=Uc[t];e===void 0&&(e=new Int32Array(t),Uc[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function Om(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function zm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(xe(e,t))return;i.uniform2fv(this.addr,t),ve(e,t)}}function Bm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(xe(e,t))return;i.uniform3fv(this.addr,t),ve(e,t)}}function km(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(xe(e,t))return;i.uniform4fv(this.addr,t),ve(e,t)}}function Gm(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(xe(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),ve(e,t)}else{if(xe(e,n))return;Fc.set(n),i.uniformMatrix2fv(this.addr,!1,Fc),ve(e,n)}}function Hm(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(xe(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),ve(e,t)}else{if(xe(e,n))return;Nc.set(n),i.uniformMatrix3fv(this.addr,!1,Nc),ve(e,n)}}function Vm(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(xe(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),ve(e,t)}else{if(xe(e,n))return;Ic.set(n),i.uniformMatrix4fv(this.addr,!1,Ic),ve(e,n)}}function Wm(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function Xm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(xe(e,t))return;i.uniform2iv(this.addr,t),ve(e,t)}}function qm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(xe(e,t))return;i.uniform3iv(this.addr,t),ve(e,t)}}function Ym(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(xe(e,t))return;i.uniform4iv(this.addr,t),ve(e,t)}}function jm(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function $m(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(xe(e,t))return;i.uniform2uiv(this.addr,t),ve(e,t)}}function Km(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(xe(e,t))return;i.uniform3uiv(this.addr,t),ve(e,t)}}function Zm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(xe(e,t))return;i.uniform4uiv(this.addr,t),ve(e,t)}}function Jm(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);const r=this.type===i.SAMPLER_2D_SHADOW?Yl:ql;e.setTexture2D(t||r,s)}function Qm(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture3D(t||$l,s)}function t0(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTextureCube(t||Kl,s)}function e0(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture2DArray(t||jl,s)}function n0(i){switch(i){case 5126:return Om;case 35664:return zm;case 35665:return Bm;case 35666:return km;case 35674:return Gm;case 35675:return Hm;case 35676:return Vm;case 5124:case 35670:return Wm;case 35667:case 35671:return Xm;case 35668:case 35672:return qm;case 35669:case 35673:return Ym;case 5125:return jm;case 36294:return $m;case 36295:return Km;case 36296:return Zm;case 35678:case 36198:case 36298:case 36306:case 35682:return Jm;case 35679:case 36299:case 36307:return Qm;case 35680:case 36300:case 36308:case 36293:return t0;case 36289:case 36303:case 36311:case 36292:return e0}}function i0(i,t){i.uniform1fv(this.addr,t)}function s0(i,t){const e=es(t,this.size,2);i.uniform2fv(this.addr,e)}function r0(i,t){const e=es(t,this.size,3);i.uniform3fv(this.addr,e)}function o0(i,t){const e=es(t,this.size,4);i.uniform4fv(this.addr,e)}function a0(i,t){const e=es(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function c0(i,t){const e=es(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function l0(i,t){const e=es(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function h0(i,t){i.uniform1iv(this.addr,t)}function u0(i,t){i.uniform2iv(this.addr,t)}function f0(i,t){i.uniform3iv(this.addr,t)}function d0(i,t){i.uniform4iv(this.addr,t)}function p0(i,t){i.uniform1uiv(this.addr,t)}function m0(i,t){i.uniform2uiv(this.addr,t)}function g0(i,t){i.uniform3uiv(this.addr,t)}function _0(i,t){i.uniform4uiv(this.addr,t)}function x0(i,t,e){const n=this.cache,s=t.length,r=wr(e,s);xe(n,r)||(i.uniform1iv(this.addr,r),ve(n,r));for(let o=0;o!==s;++o)e.setTexture2D(t[o]||ql,r[o])}function v0(i,t,e){const n=this.cache,s=t.length,r=wr(e,s);xe(n,r)||(i.uniform1iv(this.addr,r),ve(n,r));for(let o=0;o!==s;++o)e.setTexture3D(t[o]||$l,r[o])}function M0(i,t,e){const n=this.cache,s=t.length,r=wr(e,s);xe(n,r)||(i.uniform1iv(this.addr,r),ve(n,r));for(let o=0;o!==s;++o)e.setTextureCube(t[o]||Kl,r[o])}function S0(i,t,e){const n=this.cache,s=t.length,r=wr(e,s);xe(n,r)||(i.uniform1iv(this.addr,r),ve(n,r));for(let o=0;o!==s;++o)e.setTexture2DArray(t[o]||jl,r[o])}function E0(i){switch(i){case 5126:return i0;case 35664:return s0;case 35665:return r0;case 35666:return o0;case 35674:return a0;case 35675:return c0;case 35676:return l0;case 5124:case 35670:return h0;case 35667:case 35671:return u0;case 35668:case 35672:return f0;case 35669:case 35673:return d0;case 5125:return p0;case 36294:return m0;case 36295:return g0;case 36296:return _0;case 35678:case 36198:case 36298:case 36306:case 35682:return x0;case 35679:case 36299:case 36307:return v0;case 35680:case 36300:case 36308:case 36293:return M0;case 36289:case 36303:case 36311:case 36292:return S0}}class y0{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=n0(e.type)}}class b0{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=E0(e.type)}}class T0{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(t,e[a.id],n)}}}const uo=/(\w+)(\])?(\[|\.)?/g;function Oc(i,t){i.seq.push(t),i.map[t.id]=t}function w0(i,t,e){const n=i.name,s=n.length;for(uo.lastIndex=0;;){const r=uo.exec(n),o=uo.lastIndex;let a=r[1];const c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===s){Oc(e,l===void 0?new y0(a,i,t):new b0(a,i,t));break}else{let u=e.map[a];u===void 0&&(u=new T0(a),Oc(e,u)),e=u}}}class ir{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=t.getActiveUniform(e,s),o=t.getUniformLocation(e,r.name);w0(r,o,this)}}setValue(t,e,n,s){const r=this.map[e];r!==void 0&&r.setValue(t,n,s)}setOptional(t,e,n){const s=e[n];s!==void 0&&this.setValue(t,n,s)}static upload(t,e,n,s){for(let r=0,o=e.length;r!==o;++r){const a=e[r],c=n[a.id];c.needsUpdate!==!1&&a.setValue(t,c.value,s)}}static seqWithValue(t,e){const n=[];for(let s=0,r=t.length;s!==r;++s){const o=t[s];o.id in e&&n.push(o)}return n}}function zc(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const A0=37297;let R0=0;function C0(i,t){const e=i.split(`
`),n=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let o=s;o<r;o++){const a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return n.join(`
`)}function P0(i){const t=Qt.getPrimaries(Qt.workingColorSpace),e=Qt.getPrimaries(i);let n;switch(t===e?n="":t===ur&&e===hr?n="LinearDisplayP3ToLinearSRGB":t===hr&&e===ur&&(n="LinearSRGBToLinearDisplayP3"),i){case Pn:case yr:return[n,"LinearTransferOETF"];case me:case Yo:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function Bc(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),s=i.getShaderInfoLog(t).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const o=parseInt(r[1]);return e.toUpperCase()+`

`+s+`

`+C0(i.getShaderSource(t),o)}else return s}function L0(i,t){const e=P0(t);return`vec4 ${i}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function D0(i,t){let e;switch(t){case Vu:e="Linear";break;case Wu:e="Reinhard";break;case Xu:e="OptimizedCineon";break;case qu:e="ACESFilmic";break;case ju:e="AgX";break;case Yu:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}function U0(i){return[i.extensionDerivatives||i.envMapCubeUVHeight||i.bumpMap||i.normalMapTangentSpace||i.clearcoatNormalMap||i.flatShading||i.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(i.extensionFragDepth||i.logarithmicDepthBuffer)&&i.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",i.extensionDrawBuffers&&i.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(i.extensionShaderTextureLOD||i.envMap||i.transmission)&&i.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(ki).join(`
`)}function I0(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(ki).join(`
`)}function N0(i){const t=[];for(const e in i){const n=i[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function F0(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:i.getAttribLocation(t,o),locationSize:a}}return e}function ki(i){return i!==""}function kc(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Gc(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const O0=/^[ \t]*#include +<([\w\d./]+)>/gm;function Do(i){return i.replace(O0,B0)}const z0=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function B0(i,t){let e=It[t];if(e===void 0){const n=z0.get(t);if(n!==void 0)e=It[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Do(e)}const k0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Hc(i){return i.replace(k0,G0)}function G0(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Vc(i){let t="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?t+=`
#define HIGH_PRECISION`:i.precision==="mediump"?t+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(t+=`
#define LOW_PRECISION`),t}function H0(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===xl?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===vl?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===An&&(t="SHADOWMAP_TYPE_VSM"),t}function V0(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Xi:case qi:t="ENVMAP_TYPE_CUBE";break;case Er:t="ENVMAP_TYPE_CUBE_UV";break}return t}function W0(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case qi:t="ENVMAP_MODE_REFRACTION";break}return t}function X0(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Xo:t="ENVMAP_BLENDING_MULTIPLY";break;case Gu:t="ENVMAP_BLENDING_MIX";break;case Hu:t="ENVMAP_BLENDING_ADD";break}return t}function q0(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Y0(i,t,e,n){const s=i.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=H0(e),l=V0(e),h=W0(e),u=X0(e),f=q0(e),d=e.isWebGL2?"":U0(e),g=I0(e),_=N0(r),m=s.createProgram();let p,M,x=e.glslVersion?"#version "+e.glslVersion+`
...
`;class R_{constructor(t){this.canvas=t,this.renderer=new Zl({canvas:t,antialias:!0,powerPreference:"high-performance"}),this.renderer.setPixelRatio(Math.min(devicePixelRatio||1,2)),this.renderer.outputColorSpace=me,this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=vl,this.scene=new Sg,this.scene.background=L_(),this.scene.fog=new Jo(Oe(Cg),26,62),this.camera=new $e(32,1,.5,200),this.scene.add(new yg(Oe(Rg),Oe(7302744),1.3)),this.sun=new wg(Oe(16774109),2.3),this.sun.castShadow=!0,this.sun.shadow.mapSize.set(2048,2048),this.sun.shadow.camera.near=1,this.sun.shadow.bias=-.0012,this.sun.shadow.normalBias=.02,this.scene.add(this.sun),this.scene.add(this.sun.target),this.haze=new Yt(new ea(1,72),new qn({color:Oe(12571342),transparent:!0,opacity:.9,alphaMap:C_(),depthWrite:!1})),this.haze.rotation.x=-Math.PI/2,this.haze.position.y=-.55,this.scene.add(this.haze),this.landMat=new mn({vertexColors:!0}),this.land=new Yt(new ae,this.landMat),this.land.castShadow=!0,this.land.receiveShadow=!0,this.land.frustumCulled=!1,this.scene.add(this.land),this.waterUniforms={...kl.clone(et.fog),uTime:{value:0},uShallow:{value:Oe(eh)},uDeep:{value:Oe(Dg)}};const e=new Jn({uniforms:this.waterUniforms,fog:!0,vertexShader:w_,fragmentShader:A_});this.water=new Yt(new ae,e),this.water.frustumCulled=!1,this.water.renderOrder=2,this.scene.add(this.water),this.mountain=new Yt(new ae,new mn({vertexColors:!0})),this.mountain.castShadow=!0,this.mountain.receiveShadow=!0,this.mountain.visible=!1,this.scene.add(this.mountain),this.props={trunk:new Tn(this.scene,l_(),6967098),conifer:new Tn(this.scene,h_()),broadleaf:new Tn(this.scene,u_()),rock:new Tn(this.scene,f_()),bush:new Tn(this.scene,d_()),houseBody:new Tn(this.scene,p_()),houseRoof:new Tn(this.scene,m_()),pole:new Tn(this.scene,g_(),9072463),pennant:new Tn(this.scene,__(),16777215,{side:Ke})},this.ghost=new Yt(new ae,new mn({vertexColors:!0})),this.ghost.frustumCulled=!1,this.ghost.renderOrder=3,this.ghost.visible=!1,this.scene.add(this.ghost),this.ghostWater=new Yt(new ae,e),this.ghostWater.frustumCulled=!1,this.ghostWater.renderOrder=4,this.ghostWater.visible=!1,this.scene.add(this.ghostWater),this.rimMat=new qn({color:Oe(nh),transparent:!0,opacity:.9,depthWrite:!1}),this.rim=new Yt(new ae,this.rimMat),this.rim.frustumCulled=!1,this.rim.renderOrder=5,this.rim.visible=!1,this.scene.add(this.rim),this.hintMat=new Qo({color:Oe(kg),size:.5,map:P_(),transparent:!0,opacity:.5,depthWrite:!1,blending:Hi,sizeAttenuation:!0});const n=new ae;n.setAttribute("position",new _e(new Float32Array(3),3)),this.hints=new Ql(n,this.hintMat),this.hints.frustumCulled=!1,this.hints.renderOrder=1,this.scene.add(this.hints),this.flashMat=new qn({color:16777215,transparent:!0,opacity:0,blending:Hi,depthWrite:!1}),this.flash=new Yt(new ae,this.flashMat),this.flash.frustumCulled=!1,this.flash.renderOrder=6,this.flash.visible=!1,this.scene.add(this.flash),this.flashT=0,this.target=new L(0,0,0),this.wantTarget=new L(0,0,0),this.dist=22,this.wantDist=22,this.azimuth=-.62,this.polar=.74,this.plane=new Bn(new L(0,1,0),0),this.ray=new Ag,this._v=new L}resize(t,e){var r;const n=devicePixelRatio||1;this.narrow=t<720,this.renderer.setPixelRatio(Math.min(n,this.narrow&&n>=3?1.6:2));const s=this.narrow?1024:2048;this.sun.shadow.mapSize.x!==s&&(this.sun.shadow.mapSize.setScalar(s),(r=this.sun.shadow.map)==null||r.dispose(),this.sun.shadow.map=null),this.renderer.setSize(t,e,!1),this.camera.aspect=t/e,this.camera.updateProjectionMatrix(),this.lastBounds&&this.frame(this.lastBounds)}setMountain(t,e,n=null,s=.88,r=1.6){ai(this.mountain.geometry,x_(s,r,n)),this.mountain.position.set(t,0,e),this.mountain.visible=!0,this.peakY=r*1.03}setSites(t){if(this.siteRoot||(this.siteRoot=new ge,this.scene.add(this.siteRoot)),this._siteSig!==JSON.stringify(t)){this._siteSig=JSON.stringify(t),this.siteRoot.clear(),this.wheels=[];for(const e of t){let n=e.hx-e.x,s=e.hz-e.z;const r=Math.hypot(n,s)||1;n/=r,s/=r;const o=new ge;o.position.set(e.x+n*.3,.15,e.z+s*.3),o.rotation.y=Math.atan2(-s,n);const a=y_();o.add(a),this.siteRoot.add(o),this.wheels.push({wheel:a,running:e.done});const c=b_();c.position.set(e.x+n*.62-s*.3,0,e.z+s*.62+n*.3),c.rotation.y=Math.atan2(n,s),this.siteRoot.add(c)}}}setGarden(t,e){ai(this.land.geometry,t.land),ai(this.water.geometry,t.water);const n={trunk:[],conifer:[],broadleaf:[],rock:[],bush:[],houseBody:[],houseRoof:[],pole:[],pennant:[]};for(const s of t.props)switch(s.type){case zo:n.trunk.push(s),n.conifer.push({...s,colour:us[Math.floor(s.tint*us.length)%us.length]});break;case Bo:n.trunk.push(s),n.broadleaf.push({...s,colour:s.tint>.86?Fg[s.tint>.94?1:0]:us[Math.floor(s.tint*4)%4]});break;case rr:n.rock.push({...s,colour:Bg[Math.floor(s.tint*3)%3]});break;case ko:n.bush.push({...s,colour:us[Math.floor(s.tint*4)%4]});break;case lh:n.houseBody.push({...s,colour:Og[Math.floor(s.tint*3)%3]}),n.houseRoof.push({...s,colour:zg[Math.floor(s.tint*4)%4]});break;case hh:n.pole.push(s),n.pennant.push({...s,colour:Ar(Un[s.biome].top,1.3)});break}this.propLists=n,this._writeProps(),this.setLandmarks(t.landmarks??[]),e&&this.fitShadow(e)}setLandmarks(t){this.landmarkRoot||(this.landmarkRoot=new ge,this.scene.add(this.landmarkRoot),this._landmarks=new Map);const e=new Set;for(const n of t){e.add(n.id);let s=this._landmarks.get(n.id);if(!s){if(s=e_(n.kind),!s)continue;s.scale.setScalar(.01),s.userData.grow=0,this.landmarkRoot.add(s),this._landmarks.set(n.id,s)}s.position.set(n.x,0,n.z),s.rotation.y=n.rot}for(const[n,s]of this._landmarks)e.has(n)||(this.landmarkRoot.remove(s),this._landmarks.delete(n))}growTile(t){this.grown={cells:new Set(t),t:0}}_writeProps(){const t=this.grown,e=t?n=>{if(!t.cells.has(n.key))return 1;const s=Math.max(0,Math.min(1,(t.t-(n.tint??0)*ll)/_o));return s>=1?1:s*s*(3-2*s)*(1+.16*Math.sin(s*Math.PI))}:null;for(const n of Object.keys(this.propLists))this.props[n].set(this.propLists[n],e)}fitShadow({cx:t,cz:e,r:n}){const s=this.sun.shadow.camera,r=n+3;s.left=-r,s.right=r,s.top=r,s.bottom=-r,s.far=r*4+34,s.updateProjectionMatrix(),this.sunRadius=r,this.haze.position.set(t,-.55,e),this.haze.scale.setScalar(n+7)}setBeacon(t){if(!this.beacon){const e=new ge,n=new qn({color:Oe(Gg),transparent:!0,opacity:.85,depthWrite:!1,blending:Hi});this.beaconMat=n;const s=new Yt(new ia(.2,.26,18),n);s.rotation.x=-Math.PI/2,e.add(s),this.beaconMotes=[];for(let r=0;r<3;r++){const o=new Yt(new tn(.03,0),n);e.add(o),this.beaconMotes.push(o)}e.position.y=.05,e.renderOrder=2,e.visible=!1,this.beacon=e,this.scene.add(e)}if(!t){this.beacon.visible=!1;return}this.beacon.position.set(t[0],.05,t[1]),this.beacon.visible=!0}setHints(t){const e=new Float32Array(Math.max(1,t.length)*3);for(let n=0;n<t.length;n++)e[n*3]=t[n][0],e[n*3+1]=.16,e[n*3+2]=t[n][1];this.hints.geometry.setAttribute("position",new _e(e,3)),this.hints.geometry.setDrawRange(0,t.length),this.hints.geometry.computeBoundingSphere()}setGhost(t){if(!t){this.ghost.visible=!1,this.ghostWater.visible=!1,this.rim.visible=!1;return}ai(this.ghost.geometry,t.buf),ai(this.ghostWater.geometry,t.water),ai(this.rim.geometry,t.rim),this.ghost.visible=!0,this.ghostWater.visible=t.water.count>0,this.rim.visible=!0}playFlash(t){ai(this.flash.geometry,t),this.flash.visible=!0,this.flashT=1}frame(t,e=!1){const{cx:n,cz:s,r}=t;this.lastBounds=t;const o=Math.PI/2-this.polar,a=Math.tan(this.camera.fov*Math.PI/360),c=this.peakY??1,l=this.narrow?.35:.9,h=r*Math.sin(o)+c*.5*Math.cos(o)+l,u=r+l,f=Math.max(this.narrow?7:9,Math.max(h/a,u/(a*this.camera.aspect))*.96);if(this.userFramed){f>this.wantDist&&(this.wantDist=f);return}this.wantTarget.set(n,c*.22,s),this.wantDist=f,e&&(this.target.copy(this.wantTarget),this.dist=this.wantDist)}releaseCamera(){this.userFramed=!0}resetCamera(){this.userFramed=!1}orbit(t,e){this.azimuth-=t*.006,this.polar=Math.min(1.42,Math.max(.28,this.polar-e*.005))}spin(t){this.azimuth+=t}zoom(t){this.userFramed=!0,this.wantDist=Math.min(90,Math.max(4,this.wantDist*t))}pan(t,e){this.userFramed=!0;const n=this.dist*.0016,s=Math.cos(this.azimuth),r=Math.sin(this.azimuth);this.wantTarget.x+=(-t*s-e*r)*n,this.wantTarget.z+=(t*r-e*s)*n}updateCamera(t){var a;const e=1-Math.pow(.0015,t);this.target.lerp(this.wantTarget,e),this.dist+=(this.wantDist-this.dist)*e;const n=Math.sin(this.polar);this.camera.position.set(this.target.x+this.dist*n*Math.sin(this.azimuth),this.target.y+this.dist*Math.cos(this.polar),this.target.z+this.dist*n*Math.cos(this.azimuth)),this.camera.lookAt(this.target);const s=((a=this.lastBounds)==null?void 0:a.r)??6;this.scene.fog.near=Math.max(3,this.dist-s*.9),this.scene.fog.far=this.scene.fog.near+s*1.9+30;const r=this.sunRadius??10,o=this.azimuth+.84;this.sun.position.set(this.target.x+r*.8*Math.sin(o),this.target.y+r*1.15+5,this.target.z+r*.8*Math.cos(o)),this.sun.target.position.copy(this.target),this.sun.target.updateMatrixWorld()}pick(t,e){this.ray.setFromCamera({x:t,y:e},this.camera),this.plane.constant=0;const n=this.ray.ray.intersectPlane(this.plane,this._v);if(!n)return null;const[s,r,o]=dl(n.x/wt,n.z/wt);return{cell:cn(s,r,o),x:n.x,z:n.z}}project(t,e,n){return this._v.set(t,e,n).project(this.camera),this._v}render(t,e){var n;if(this.waterUniforms.uTime.value=e,this.grown&&(this.grown.t+=t,this.grown.t>_o+ll&&(this.grown=null),this._writeProps()),this._landmarks)for(const s of this._landmarks.values()){if(s.userData.grow===void 0)continue;const r=s.userData.grow+=t/(_o*1.8);r>=1?(s.scale.setScalar(1),delete s.userData.grow):s.scale.setScalar(r*r*(3-2*r)*(1+.12*Math.sin(r*Math.PI)))}this.hintMat.opacity=.34+.2*Math.sin(e*1.6),(n=this.beacon)!=null&&n.visible&&(this.beacon.rotation.y=e*.8,this.beaconMat.opacity=.6+.35*Math.sin(e*2.6),this.beaconMotes.forEach((s,r)=>{const o=e*1.4+r/3*Math.PI*2;s.position.set(Math.cos(o)*.27,.04+.05*Math.sin(e*3+r),Math.sin(o)*.27)}));for(const s of this.wheels??[])s.running&&(s.wheel.rotation.z-=t*1.5);this.rimMat.opacity=.62+.3*Math.sin(e*3.4),this.flashT>0&&(this.flashT=Math.max(0,this.flashT-t*1.15),this.flashMat.opacity=Math.sin(Math.min(1,this.flashT)*Math.PI)*.5,this.flash.visible=this.flashT>0),this.renderer.render(this.scene,this.camera)}}function C_(){const i=document.createElement("canvas");i.width=i.height=128;const t=i.getContext("2d"),e=t.createRadialGradient(64,64,6,64,64,64);return e.addColorStop(0,"#fff"),e.addColorStop(.45,"#fff"),e.addColorStop(1,"#000"),t.fillStyle=e,t.fillRect(0,0,128,128),new ta(i)}function P_(){const i=document.createElement("canvas");i.width=i.height=64;const t=i.getContext("2d"),e=t.createRadialGradient(32,32,0,32,32,32);e.addColorStop(0,"rgba(255,255,255,1)"),e.addColorStop(.18,"rgba(255,246,214,0.85)"),e.addColorStop(.55,"rgba(255,232,168,0.22)"),e.addColorStop(1,"rgba(255,232,168,0)"),t.fillStyle=e,t.fillRect(0,0,64,64);const n=new ta(i);return n.colorSpace=me,n}function L_(){const i=document.createElement("canvas");i.width=4,i.height=256;const t=i.getContext("2d"),e=t.createLinearGradient(0,0,0,256);e.addColorStop(0,"#9fc4dc"),e.addColorStop(.45,"#c9dfe8"),e.addColorStop(.78,"#e4eee6"),e.addColorStop(1,"#eef1e4"),t.fillStyle=e,t.fillRect(0,0,4,256);const n=new ta(i);return n.colorSpace=me,n}function ai(i,t){i.setAttribute("position",new _e(new Float32Array(t.pos),3)),i.setAttribute("normal",new _e(new Float32Array(t.nrm),3)),i.setAttribute("color",new _e(new Float32Array(t.col),3)),i.computeBoundingSphere()}const er=i=>new Gt(i).convertSRGBToLinear();function D_(){const i=new ae,t=new Float32Array([0,0,0,-.16,.05,-.07,-.13,0,.04,0,0,0,.13,0,.04,.16,.05,-.07]);return i.setAttribute("position",new _e(t,3)),i.computeVertexNormals(),i}function Oi(i,t,e){const n=new tn(1,0);return n.scale(i,t,e),n}function U_(){const i=new tn(1,0);return i.scale(.055,.03,.13),i}class wn{constructor(t,e,n,s){this.mesh=new Jl(e,n,s),this.mesh.frustumCulled=!1,this.mesh.count=0,this.mesh.instanceMatrix.setUsage(Ll),t.add(this.mesh),this.m=new oe,this.q=new _i,this.p=new L,this.s=new L,this.n=0}begin(){this.n=0}put(t,e,n,s,r,o,a){this.n>=this.mesh.instanceMatrix.count||(this.p.set(t,e,n),this.q.setFromAxisAngle(I_,s),this.s.set(r,o??r,a??r),this.m.compose(this.p,this.q,this.s),this.mesh.setMatrixAt(this.n++,this.m))}end(){this.mesh.count=this.n,this.mesh.instanceMatrix.needsUpdate=!0}}const I_=new L(0,1,0);function N_(i){const t=r=>`${r[0].toFixed(3)},${r[1].toFixed(3)}`,e=new Map;i.forEach((r,o)=>{for(const a of[r[0],r[r.length-1]]){const c=t(a);e.has(c)||e.set(c,[]),e.get(c).push(o)}});const n=new Set,s=[];for(let r=0;r<i.length;r++){if(n.has(r))continue;n.add(r);let o=i[r].slice();for(let a=0;a<60;a++){const c=t(o[o.length-1]),l=(e.get(c)??[]).find(f=>!n.has(f));if(l===void 0)break;n.add(l);const h=i[l],u=t(h[0])===c?h:h.slice().reverse();o=o.concat(u.slice(1))}o.length>=8&&s.push(o)}return s.sort((r,o)=>o.length-r.length),s}const F_=[{key:"rabbit",on:"meadow",size:[.03,.03,.042],colour:12167315,head:13483432,n:3,cap:4,hop:.05,speed:.5,every:26},{key:"fox",on:"meadow",size:[.032,.03,.075],colour:12873786,head:14191182,n:1,cap:2,hop:.012,speed:.42,every:52},{key:"boar",on:"forest",size:[.05,.045,.09],colour:5523262,head:6969933,n:2,cap:3,hop:.008,speed:.26,every:38},{key:"goat",on:"stone",size:[.036,.04,.058],colour:14999250,head:13287342,n:3,cap:4,hop:.02,speed:.3,every:32},{key:"cow",on:"meadow",size:[.055,.05,.095],colour:14274496,head:9071186,n:2,cap:3,hop:.004,speed:.16,every:44},{key:"duck",on:"water",size:[.022,.02,.036],colour:15788760,head:5073734,n:4,cap:5,hop:.006,speed:.18,every:30}];class O_{constructor(t){this.root=new ge,t.add(this.root);const e=(r,o={})=>new mn({color:er(r),...o});this.birds=new wn(this.root,D_(),new qn({color:er(4871520),side:Ke,transparent:!0,opacity:.7}),9),this.deer=new wn(this.root,Oi(.05,.045,.1),e(11106379),6),this.deerHead=new wn(this.root,Oi(.03,.03,.035),e(12159580),6),this.sheep=new wn(this.root,Oi(.05,.045,.062),e(15986660),14),this.kayak=new wn(this.root,U_(),e(14245951),2),this.paddler=new wn(this.root,Oi(.032,.045,.032),e(4157324),2),this.smoke=new wn(this.root,new tn(1,0),new qn({color:er(15922418),transparent:!0,opacity:.2,depthWrite:!1}),44),this.smoke.mesh.renderOrder=5,this.critters=F_.map(r=>({spec:r,body:new wn(this.root,Oi(r.size[0],r.size[1],r.size[2]),e(r.colour),r.cap),head:r.head?new wn(this.root,Oi(r.size[0]*.6,r.size[1]*.6,r.size[1]*.7),e(r.head),r.cap):null,party:null,at:5+Math.random()*14}));const n=90,s=new ae;s.setAttribute("position",new _e(new Float32Array(n*3),3)),this.motes=new Ql(s,new Qo({color:er(16774088),size:.045,transparent:!0,opacity:.55,depthWrite:!1,blending:Hi})),this.motes.frustumCulled=!1,this.root.add(this.motes),this.moteHome=[],this.moteN=n,this.reset()}reset(){this.flock=null,this.flockAt=6,this.deerParty=null,this.deerAt=9,this.boat=null,this.boatAt=4,this.flocks=[],this.sheepSpots=[],this.chimneys=[],this.rivers=[],this.forest=[],this.grazing=[],this.stone=[],this.meadow=[],this.water=[];for(const t of this.critters??[])t.party=null,t.at=5+Math.random()*14;this.t=0}sync(t,e=[]){const n=t.board,s=r=>{const[o,a]=ke(Wt(r),Xt(r),jt(r));return[o*wt,0,a*wt]};this.forest=[],this.grazing=[],this.chimneys=[],this.stone=[],this.meadow=[];for(const r of n.filled){const o=n.biome.get(r);o===Zi?this.forest.push(s(r)):o===ln||o===pi?this.grazing.push(s(r)):o===hn&&this.chimneys.push(s(r)),o===ln?this.meadow.push(s(r)):(o===Qn||o===pi)&&this.stone.push(s(r))}this.rivers=N_(e),this.water=[];for(const r of n.tiles){if(r.ports.size!==1)continue;const[o,a]=xn(r.cells);this.water.push([o,.02,a])}if(this.grazing.length>3)for(this.sheepSpots=this.sheepSpots.filter(r=>this.grazing.some(o=>Math.abs(o[0]-r.x)<.01&&Math.abs(o[2]-r.z)<.01));this.sheepSpots.length<Math.min(2,Math.floor(this.grazing.length/8));){const r=this.grazing[Math.floor(Math.random()*this.grazing.length)];this.sheepSpots.push({x:r[0],y:r[1],z:r[2],n:3+Math.floor(Math.random()*3),ph:Math.random()*9})}this.moteHome=[];for(let r=0;r<this.moteN;r++){const o=this.forest.length?this.forest[Math.floor(Math.random()*this.forest.length)]:null;this.moteHome.push(o?[o[0],o[1],o[2]]:null)}}celebrate(t){var e;t.joined>0&&(this.boatAt=Math.min(this.boatAt,2)),(e=t.announce)!=null&&e.length&&(this.flockAt=Math.min(this.flockAt,2.5))}update(t,e,n){this.t=e,this._birds(t,e),this._deer(t,e),this._sheep(e),this._boat(t,e),this._critters(t,e),this._smoke(e),this._motes(e)}_birds(t,e){if(this.birds.begin(),this.flock){const n=this.flock,s=2.4;n.x+=n.vx*s*t,n.z+=n.vz*s*t,n.life+=t;const r=Math.atan2(n.vx,n.vz);for(let o=0;o<n.n;o++){const a=o*.55,c=(o%2?1:-1)*Math.ceil(o/2)*.42,l=n.x-n.vx*a+-n.vz*c,h=n.z-n.vz*a+n.vx*c,u=1+Math.sin(e*7+o*1.7)*.35;this.birds.put(l,n.y+Math.sin(e*.7+o)*.12,h,r,1,u,1)}n.life>26&&(this.flock=null)}else if(this.flockAt-=t,this.flockAt<=0){const n=Math.random()*Math.PI*2,s=16+Math.random()*8,r=Math.cos(n)*s,o=Math.sin(n)*s;this.flock={x:r,z:o,y:4.4+Math.random()*2.6,vx:-r/s,vz:-o/s,n:3+Math.floor(Math.random()*4),life:0},this.flockAt=22+Math.random()*26}this.birds.end()}_deer(t,e){if(this.deer.begin(),this.deerHead.begin(),this.deerParty){const n=this.deerParty;n.life+=t;const s=Math.min(1,n.life*2,Math.max(0,(13-n.life)*.7));for(let r=0;r<n.n;r++){const o=Math.sin(e*.5+n.ph+r*2.1),a=Math.cos(n.dir+r*1.9)*(.12+.05*o),c=Math.sin(n.dir+r*1.9)*(.12+.05*o),l=n.dir+o*.5,h=n.y+.055;this.deer.put(n.x+a,h,n.z+c,l,s,s,s),this.deerHead.put(n.x+a+Math.sin(l)*.085,h+.035+Math.sin(e*1.3+n.ph)*.012,n.z+c+Math.cos(l)*.085,l,s,s,s)}n.life>14&&(this.deerParty=null)}else{this.deerAt-=t;const n=this.forest.length?this.forest:this.grazing;if(this.deerAt<=0&&n.length){const s=n[Math.floor(Math.random()*n.length)];this.deerParty={x:s[0],y:s[1],z:s[2],n:1+(Math.random()<.5?1:0),life:0,dir:Math.random()*Math.PI*2,ph:Math.random()*8},this.deerAt=16+Math.random()*22}}this.deer.end(),this.deerHead.end()}_sheep(t){this.sheep.begin();for(const e of this.sheepSpots)for(let n=0;n<e.n;n++){const s=e.ph+n*2.3,r=.11+.05*Math.sin(t*.13+s);this.sheep.put(e.x+Math.cos(s+t*.035)*r,e.y+.045,e.z+Math.sin(s+t*.035)*r,s,1,1,1)}this.sheep.end()}_boat(t,e){if(this.kayak.begin(),this.paddler.begin(),this.boat){const n=this.boat.path;this.boat.u+=t*1.6;const s=Math.floor(this.boat.u);if(s>=n.length-1)this.boat=null;else{const r=this.boat.u-s,o=n[s],a=n[s+1],c=o[0]+(a[0]-o[0])*r,l=o[1]+(a[1]-o[1])*r,h=.03,u=Math.atan2(a[0]-o[0],a[1]-o[1]),f=Math.sin(e*3.1)*.008;this.kayak.put(c,h+f,l,u,1,1,1),this.paddler.put(c,h+.045+f,l,u+Math.sin(e*4.2)*.28,1,1,1)}}else if(this.boatAt-=t,this.boatAt<=0&&this.rivers.length){const n=this.rivers[Math.floor(Math.random()*Math.min(3,this.rivers.length))];this.boat={path:n,u:0},this.boatAt=20+Math.random()*28}this.kayak.end(),this.paddler.end()}_critters(t,e){var n,s;for(const r of this.critters){const o=r.spec;r.body.begin(),(n=r.head)==null||n.begin();const a=this[o.on]??[];if(r.party){const c=r.party;c.life+=t;const l=Math.min(1,c.life*1.6,Math.max(0,(c.span-c.life)*.5));for(const h of c.who){const u=h.a+e*o.speed*h.w,f=c.x+Math.cos(u)*h.r,d=c.z+Math.sin(u)*h.r,g=Math.abs(Math.sin(e*3.4+h.b))*o.hop,_=u+(h.w>0?Math.PI/2:-Math.PI/2);r.body.put(f,c.y+g,d,_,l),r.head&&r.head.put(f+Math.cos(_)*o.size[2]*.85,c.y+g+o.size[1]*.55,d+Math.sin(_)*o.size[2]*.85,_,l)}c.life>c.span&&(r.party=null)}else if(r.at-=t,r.at<=0&&a.length){const c=a[Math.floor(Math.random()*a.length)];r.party={x:c[0],y:c[1],z:c[2],life:0,span:14+Math.random()*12,ph:Math.random()*9,who:Array.from({length:o.n},()=>({a:Math.random()*Math.PI*2,r:.06+Math.random()*.18,w:(Math.random()<.5?-1:1)*(.5+Math.random()),b:Math.random()*7}))},r.at=o.every*(.6+Math.random()*.8)}r.body.end(),(s=r.head)==null||s.end()}}_smoke(t){this.smoke.begin();for(let e=0;e<this.chimneys.length&&e<11;e++){const[n,s,r]=this.chimneys[e];for(let o=0;o<4;o++){const a=(t*.22+o*.25+e*.37)%1,c=a*.75,l=.02+a*.055,h=a*a*.22;this.smoke.put(n+h,s+.24+c,r+h*.4,0,l*(1-a*.35))}}this.smoke.end()}_motes(t){const e=this.motes.geometry.attributes.position.array;let n=0;for(let s=0;s<this.moteN;s++){const r=this.moteHome[s];r&&(e[n*3]=r[0]+Math.sin(t*.6+s*1.7)*.18,e[n*3+1]=r[1]+.22+Math.sin(t*.9+s*2.3)*.1,e[n*3+2]=r[2]+Math.cos(t*.5+s*2.9)*.18,n++)}this.motes.geometry.setDrawRange(0,n),this.motes.geometry.attributes.position.needsUpdate=!0}}const Dn=document.getElementById("scene"),_t=i=>document.getElementById(i),qt=new R_(Dn),bs=new O_(qt.scene);matchMedia("(hover: none) and (pointer: coarse)").matches&&document.body.classList.add("touch");let st,Zt=null,vs=null,ns=!1;function uh(i){let t=1/0,e=-1/0,n=1/0,s=-1/0;for(const c of i.board.filled){const[l,h]=ke(Wt(c),Xt(c),jt(c));l<t&&(t=l),l>e&&(e=l),h<n&&(n=h),h>s&&(s=h)}const r=(t+e)/2*wt,o=(n+s)/2*wt,a=Math.max(e-t,s-n)*.5*wt+.7;return{cx:r,cz:o,r:a}}function fh(){const i=new Set,t=[];for(const e of st.fits){const[n,s]=xn(e.cells),r=`${Math.round(n/.55)},${Math.round(s/.55)}`;if(!i.has(r)&&(i.add(r),t.push([n,s]),t.length>=160))break}return t}function Cr(i=!1){const t=s_(st),e=uh(st);qt.setGarden(t,e),qt.frame(e,i),bs.sync(st,t.branches),qt.setHints(st.over?[]:fh());const n=st.over?null:st.suggestion;qt.setBeacon(n?xn(n.cells):null),qt.setSites(st.sites.map(s=>({x:s.mid[0]*wt,z:s.mid[1]*wt,hx:s.hub[0]*wt,hz:s.hub[1]*wt,done:s.done})))}const z_=_t("tileart").getContext("2d"),B_=_t("nextart").getContext("2d"),k_=_t("tilesparkle").getContext("2d"),dh=i=>!!(i&&(i.camp||i.crafted||i.kind==="confluence"||i.lake)),G_=Array.from({length:22},(i,t)=>({x:t*37%100,y:t*61%100,ph:t*.41%1,sp:.22+t*13%7/20,r:1+t*7%5*.5}));function H_(i){const t=k_,e=t.canvas.width,n=t.canvas.height;if(t.clearRect(0,0,e,n),!!dh(st==null?void 0:st.tile))for(const s of G_){const r=(s.ph+i*s.sp)%1,o=s.x/100*e+Math.sin((r+s.ph)*6.3)*9,a=(1-r)*n*.92+s.y/100*n*.08,c=Math.sin(r*Math.PI)**2;if(c<.02)continue;const l=s.r*(2+c*2.2),h=t.createRadialGradient(o,a,0,o,a,l*3);h.addColorStop(0,`rgba(255,240,190,${.9*c})`),h.addColorStop(.4,`rgba(255,198,90,${.5*c})`),h.addColorStop(1,"rgba(255,198,90,0)"),t.fillStyle=h,t.beginPath(),t.arc(o,a,l*3,0,Math.PI*2),t.fill()}}const ph=i=>mh(z_,st.tile,i,14,2.2);function mh(i,t,e,n,s){const r=i.canvas.width,o=i.canvas.height;if(i.clearRect(0,0,r,o),!t)return;const c=Yn[e].map(([M,x,v])=>Ki(M,x,v).map(([R,T])=>Je(R,T)));let l=1/0,h=-1/0,u=1/0,f=-1/0;for(const M of c)for(const[x,v]of M)l=Math.min(l,x),h=Math.max(h,x),u=Math.min(u,v),f=Math.max(f,v);const d=Math.min((r-n*2)/(h-l),(o-n*2)/(f-u)),g=(r-(h-l)*d)/2-l*d,_=(o-(f-u)*d)/2+f*d,m=([M,x])=>[g+M*d,_-x*d];i.lineJoin="round",i.lineCap="round";for(let M=0;M<8;M++)i.beginPath(),c[M].forEach((x,v)=>{const[R,T]=m(x);v===0?i.moveTo(R,T):i.lineTo(R,T)}),i.closePath(),i.fillStyle=mo(Un[t.biomes[M]].top),i.fill(),i.strokeStyle="rgba(255,255,255,0.3)",i.lineWidth=1,i.stroke();i.beginPath(),Gh(e).forEach((M,x)=>{const[v,R]=m(M);x===0?i.moveTo(v,R):i.lineTo(v,R)}),i.closePath(),i.strokeStyle="rgba(34,45,54,0.7)",i.lineWidth=s,i.stroke();const p=t.adaptive?Ss:[...t.ports];if(p.length){const M=ye(e,0,0),x=xn(M);i.globalAlpha=t.adaptive?.45:1,t.adaptive&&i.setLineDash([3.2*s,3.2*s]);for(const v of[0,1]){i.strokeStyle=mo(v===0?Wi:eh),i.lineWidth=(v===0?4.1:2.3)*s;for(const R of p){const T=aa(M,e,R,x);i.beginPath(),T.forEach((A,I)=>{const[S,b]=m([A[0]/wt,A[1]/wt]);I===0?i.moveTo(S,b):i.lineTo(S,b)}),i.stroke()}if(p.length===1||t.adaptive){const[R,T]=m([x[0]/wt,x[1]/wt]);i.beginPath(),i.setLineDash([]),i.arc(R,T,(v===0?2.3:1.55)*s,0,Math.PI*2),i.fillStyle=i.strokeStyle,i.fill(),t.adaptive&&i.setLineDash([3.2*s,3.2*s])}}i.setLineDash([]),i.globalAlpha=1}}function gh(i,t=0,e=0){if(!st||st.over||!i){Ms();return}const n=[i.cell],r=Ne(Wt(i.cell),Xt(i.cell),jt(i.cell)).map(o=>{const[a,c]=ke(Wt(o),Xt(o),jt(o));return{k:o,d:Math.hypot(a*wt-i.x,c*wt-i.z)}}).sort((o,a)=>o.d-a.d);for(const o of r)n.push(o.k);for(const o of n)if(_h(o))return;xh(t,e,W_)||Ms()}function _h(i){const t=st.fitsAtCell(i);if(t.length===0)return!1;let e=0;if(vs!==null){const n=t.findIndex(s=>s.o===vs);n>=0&&(e=n)}return Zt={cell:i,fits:t,index:e},Mh(),!0}const V_=()=>Math.max(110,Math.min(innerWidth,innerHeight)*.28),W_=72;function xh(i,t,e=V_()){let n=null,s=1/0;for(const r of st.fits){const[o,a]=xn(r.cells),c=qt.project(o,.02,a),l=Math.hypot((c.x+1)/2*innerWidth-i,(1-c.y)/2*innerHeight-t);l<s&&(s=l,n=r)}return!n||s>e?!1:_h(n.cells[0])}function Ms(){Zt=null,qt.setGhost(null),_t("fitcount").textContent="",_t("contact").textContent="",vh(!1)}function vh(i){const t=i&&Zt?Zt.fits.length:0;_t("lay").disabled=!i,_t("prev").disabled=t<2,_t("next").disabled=t<2}function Mh(){if(!Zt)return;const i=Zt.fits[Zt.index],t=a_(i.cells,st.tile,i.o,i.ports??st.tile.ports);t.rim=c_(t.outline,.028,.022,nh),qt.setGhost(t),_t("fitcount").textContent=Zt.fits.length>1?`${Zt.index+1}/${Zt.fits.length}`:"";const e=_t("contact"),n=i.match*3+i.joins*6+(i.touch>0&&i.match===i.touch?12:0),s=[];i.joins>0&&s.push(`${i.joins} stream${i.joins>1?"s":""} carried on`),i.match>0?s.push(`${i.match} of ${i.touch} edges agree`):i.touch>0?s.push(`${i.touch} edge${i.touch>1?"s":""} met, none agree`):s.push("standing on its own"),e.textContent=n>0?`${s.join(" · ")} · +${n}`:s.join(" · "),e.classList.toggle("flush",i.touch>0&&i.match===i.touch),vh(!0),ph(i.o)}function $i(i){Zt&&(Zt.index=(Zt.index+i+Zt.fits.length)%Zt.fits.length,vs=Zt.fits[Zt.index].o,Mh())}function Sh(){if(!Zt||!st||st.over)return;const i=Zt.fits[Zt.index],t=st.place(i);Cr(),qt.growTile(t.cells);const e=hl(i.cells);t.fitScore>0&&zi(e,`+${t.fitScore}`,t.perfect);for(const n of t.announce){const s=st.board.regionCells(n.root);qt.playFlash(Go(s)),zi(hl(s),`${Zn[n.biome]} +${n.score}`,!0)}if(t.camp&&zi(e,`${t.camp.title} · +${t.camp.score}`,!0,.2),t.harvest&&st.works.forEach((n,s)=>{var o;const r=((o=Sr.find(a=>a.key===n.resource))==null?void 0:o.glyph)??"·";zi([n.at[0]*wt,.5,n.at[1]*wt],`${r}+1`,!1,.1+s*.06)}),t.bonus>0&&zi(e,`+${t.bonus} tiles`,!1,.5),t.quest){const n=t.quest;zi([n.hub[0]*wt,.9,n.hub[1]*wt],`${n.title} · +${n.score}`,!0,.25),qt.playFlash(Go(n.cells??[]))}bs.celebrate(t),Ms(),Ts(),st.over&&J_()}function hl(i){const[t,e]=xn(i);return[t,.3,e]}function Go(i){const t=new gi;for(const e of i){const n=Ki(Wt(e),Xt(e),jt(e)).map(([s,r])=>{const[o,a]=Je(s,r);return[o*wt,.02,a*wt]});t.tri(n[0],n[2],n[1],16777215),t.tri(n[0],n[3],n[2],16777215)}return t}function zi([i,t,e],n,s=!1,r=0){const o=qt.project(i,t,e),a=document.createElement("span");a.textContent=n,s||(a.className="small"),a.style.left=`${(o.x+1)/2*innerWidth}px`,a.style.top=`${(1-o.y)/2*innerHeight}px`,a.style.animationDelay=`${r}s`,_t("pops").appendChild(a),setTimeout(()=>a.remove(),1900+r*1e3)}const X_=_l.map(i=>{const t=document.createElement("button");return t.className="recipe",t.title=i.note,t.innerHTML='<b></b><span class="cost"></span>',t.querySelector("b").textContent=i.title,t.addEventListener("click",()=>{!st||!st.craft(i.key)||ha()}),_t("recipes").appendChild(t),{r:i,b:t}}),q_=Object.fromEntries(Sr.map(i=>[i.key,i.glyph]));function Y_(){const i=_t("shop");if(!st.works.length&&!Object.values(st.res).some(t=>t>0)){i.classList.add("hidden");return}i.classList.remove("hidden"),_t("purse").textContent=Sr.filter(t=>st.res[t.key]>0).map(t=>`${t.glyph}${st.res[t.key]}`).join("  ");for(const{r:t,b:e}of X_){const n=st.costOf(t);e.querySelector(".cost").textContent=Object.entries(n).map(([s,r])=>`${q_[s]}${r}`).join(" "),e.disabled=st.over||!st.affordable(t)}}function Ts(){Y_(),_t("score").textContent=st.score.toLocaleString(),_t("tiles").textContent=Math.max(0,st.tilesLeft),_t("sealed").textContent=st.sealedCount;const i=st.biggestOpen();_t("growing").textContent=i&&i.size>2?`${i.size} · ${Zn[i.biome]}`:"—",_t("tilekind").textContent=Z_(st.tile),_t("tilecard").classList.toggle("special",dh(st.tile));const t=st.quest??st.sites[st.sites.length-1],e=_t("quest");t?(e.classList.remove("hidden"),e.classList.toggle("done",!!t.done),_t("questtitle").textContent=t.done?`${t.title} ✓`:t.title,_t("questhint").textContent=t.done?t.unlockNote||"Done.":t.hint):e.classList.add("hidden");const n=_t("swap");st.canChoose&&!st.over&&st.queue[1]?(n.classList.remove("hidden"),mh(B_,st.queue[1],0,8,1.1)):n.classList.add("hidden"),K_(),ph(Zt?Zt.fits[Zt.index].o:0)}const j_=3400,$_=550;let or=0;function K_(){const i=_t("feed"),t=st.log.filter(e=>e.id>or).reverse();for(const e of t){or=Math.max(or,e.id);const n=document.createElement("div");n.textContent=e.text,i.appendChild(n),setTimeout(()=>{n.classList.add("going"),setTimeout(()=>n.remove(),$_)},j_)}_t("historycount").textContent=st.log.length,t.length&&!_t("history").classList.contains("shut")&&Eh()}function Eh(){const i=_t("historylist");if(i.textContent="",!st.log.length){const t=document.createElement("li");t.className="empty",t.textContent="nothing has scored yet",i.appendChild(t);return}for(const t of st.log){const e=document.createElement("li");e.textContent=t.text,i.appendChild(e)}}function Z_(i){if(!i)return"";if(i.adaptive)return"water works · joins every stream it touches";if(i.camp)return`${i.camp.title} · needs ${Zn[i.camp.biome]}`;const t=new Map;for(const s of i.biomes)t.set(s,(t.get(s)??0)+1);const e=[...t.entries()].sort((s,r)=>r[1]-s[1]).map(([s])=>Zn[s]),n=i.ports.size?` · ${i.kind==="fitted"?"stream":i.kind}`:"";return e.slice(0,2).join(" + ")+n}function J_(){_t("finalscore").textContent=st.score.toLocaleString();const i=st.sealedCount;_t("finalnote").textContent=`${st.placed} hats laid · ${i} region${i===1?"":"s"} sealed`+(st.best.size?` · largest ${st.best.size} kites of ${Zn[st.best.biome]}`:"");const t=_t("finaltally");t.textContent="";for(const e of(st.openTally??[]).slice(0,8)){const n=document.createElement("li");n.innerHTML=`<span>${e.size} kites of ${Zn[e.biome]} · left open</span><b>+${e.score}</b>`,t.appendChild(n)}setTimeout(()=>_t("gameover").classList.remove("hidden"),900)}const yh=4,Q_=11,dn=new Map;let kn=null,Ho=!1,_r=0,xr=0,vr=0,ca=0,la=yh;const bh=(i,t)=>[i/innerWidth*2-1,-(t/innerHeight)*2+1];function Th(){const[i,t]=[...dn.values()];return{gap:Math.max(1,Math.hypot(i.x-t.x,i.y-t.y)),cx:(i.x+t.x)/2,cy:(i.y+t.y)/2,angle:Math.atan2(t.y-i.y,t.x-i.x)}}function wh(i,t){try{t?Dn.setPointerCapture(i):Dn.releasePointerCapture(i)}catch{}}Dn.addEventListener("pointerdown",i=>{i.pointerType==="touch"&&document.body.classList.add("touch"),dn.set(i.pointerId,{x:i.clientX,y:i.clientY}),wh(i.pointerId,!0),dn.size===1?(_r=0,Ho=!1,ca=i.button,la=i.pointerType==="mouse"?yh:Q_,xr=i.clientX,vr=i.clientY):(Ho=!0,dn.size===2&&(kn=Th()))});Dn.addEventListener("pointermove",i=>{const t=dn.get(i.pointerId);if(t&&(t.x=i.clientX,t.y=i.clientY),dn.size>=2){const e=Th();if(kn){qt.zoom(kn.gap/e.gap),qt.pan(e.cx-kn.cx,e.cy-kn.cy);let n=e.angle-kn.angle;n>Math.PI?n-=Math.PI*2:n<-Math.PI&&(n+=Math.PI*2),qt.spin(n)}kn=e,document.body.classList.add("dragging");return}if(t){const e=i.clientX-xr,n=i.clientY-vr;_r+=Math.abs(e)+Math.abs(n),xr=i.clientX,vr=i.clientY,_r>la&&(document.body.classList.add("dragging"),ca===2||i.shiftKey?qt.pan(e,n):qt.orbit(e,n));return}!ns||i.pointerType==="touch"||gh(qt.pick(...bh(i.clientX,i.clientY)),i.clientX,i.clientY)});function Ah(i){const t=dn.delete(i.pointerId);if(wh(i.pointerId,!1),dn.size<2&&(kn=null),dn.size>0){const[e]=[...dn.values()];xr=e.x,vr=e.y;return}if(document.body.classList.remove("dragging"),!(!t||Ho||_r>la||ca!==0||!ns)){if(i.pointerType==="touch"){const e=qt.pick(...bh(i.clientX,i.clientY));if(!Zt||!e||!Zt.fits[Zt.index].cells.includes(e.cell)){gh(e,i.clientX,i.clientY),Zt||xh(i.clientX,i.clientY);return}}Sh()}}Dn.addEventListener("pointerup",Ah);Dn.addEventListener("pointercancel",Ah);Dn.addEventListener("contextmenu",i=>i.preventDefault());const tx=16,ex=400;function nx(i){return i.deltaMode===1?i.deltaY*tx:i.deltaMode===2?i.deltaY*ex:i.deltaY}let ul=0;Dn.addEventListener("wheel",i=>{i.preventDefault();const t=nx(i);if(i.shiftKey||i.ctrlKey||!Zt){qt.zoom(Math.exp(Math.max(-120,Math.min(120,t))*.0016));return}const e=performance.now();Math.abs(t)<2||e-ul<110||(ul=e,$i(t>0?1:-1))},{passive:!1});addEventListener("keydown",i=>{if(!ns)return;const t=i.key.toLowerCase();if(t==="q")$i(-1);else if(t==="e"||t===" ")$i(1);else if(t==="r")Rh();else if(t==="l")Ch();else if(t==="+"||t==="=")qt.zoom(.85);else if(t==="-")qt.zoom(1.18);else return;i.preventDefault()});function Rh(){st.reroll()&&ha()}function ha(){vs=null,Ms(),qt.setHints(fh());const i=st.suggestion;qt.setBeacon(i?xn(i.cells):null),Ts()}const ua=()=>qt.resize(innerWidth,innerHeight);addEventListener("resize",ua);addEventListener("orientationchange",()=>setTimeout(ua,250));visualViewport==null||visualViewport.addEventListener("resize",ua);_t("top").addEventListener("click",()=>{qt.resetCamera(),st&&qt.frame(uh(st))});const Ch=()=>{_t("history").classList.toggle("shut")||Eh()};_t("historytoggle").addEventListener("click",Ch);function ws(i){var s;st=new pu(i),vs=null,ns=!0,or=0,_t("feed").textContent="",_t("history").classList.add("shut"),Ms(),bs.reset(),qt.resetCamera();const[t,e]=Je(ar[0],ar[1]),n=(s=st.headwater)==null?void 0:s.dir;qt.setMountain(t*wt,e*wt,n?Math.atan2(n[1],n[0]):null),Cr(!0),Ts(),_t("gameover").classList.add("hidden")}_t("prev").addEventListener("click",()=>$i(-1));_t("next").addEventListener("click",()=>$i(1));_t("tileart").addEventListener("click",()=>$i(1));_t("lay").addEventListener("click",Sh);_t("toss").addEventListener("click",Rh);_t("swap").addEventListener("click",()=>{st.swapNext()&&ha()});_t("play").addEventListener("click",()=>{_t("intro").remove(),_t("startbar").classList.add("hidden"),ws((Math.random()*1e9|0)+1)});_t("watch").addEventListener("click",()=>{_t("intro").remove(),_t("startbar").classList.remove("hidden")});_t("startbar").addEventListener("click",()=>{_t("startbar").classList.add("hidden"),ws((Math.random()*1e9|0)+1)});_t("again").addEventListener("click",()=>ws(Math.random()*1e9|0));let xo=.6;const ix=34;function fa(){if(!st||st.over||st.placed>=ix+3)return;const i=st.fits;if(!i.length)return;let t=null,e=-1/0;for(const s of i){const r=st._harmony(s.o,s.cells,st.tile),o=r.joins*6+r.match*3+r.touch+Math.random()*2;o>e&&(e=o,t=s)}const n=st.place(t);Cr(),qt.growTile(n.cells);for(const s of n.announce)qt.playFlash(Go(st.board.regionCells(s.root)));Ts()}window.aperiodicGarden={get game(){return st},get hover(){return Zt},get scene(){return qt},step:fa,restart:ws,get ambience(){return bs},refresh:()=>{Cr(),Ts()}};qt.resize(innerWidth,innerHeight);ws(1741);ns=!1;for(let i=0;i<20;i++)fa();let fl=performance.now(),nr=0;function Ph(i){const t=Math.min(.05,(i-fl)/1e3);fl=i,nr+=t,ns||(xo-=t,xo<=0&&(xo=.34,fa())),qt.updateCamera(t),bs.update(t,nr,st),qt.render(t,nr),H_(nr),requestAnimationFrame(Ph)}requestAnimationFrame(Ph);
